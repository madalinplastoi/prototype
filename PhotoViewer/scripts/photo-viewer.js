...
function PhotoViewerPlugin() {
	...
	//Think why this works while using a SelectedImage computed did not work!!!
    ...
    self.open = function (images, selectedIndex) {
        $.modal("<div></div>", {
            ...
            onShow: function (dialog) {
                $('#simplemodal-data').load(("static/modal.html"), function () {
            ...
            onClose: function (dialog) {
                $.modal.close();
                document.onkeydown = null; // with this i "detached" my event
            },
			overlayClose: true,
			escClose: true,
        });
